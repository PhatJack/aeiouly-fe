...
import WordPronunciation from '@/components/app/gym/detail/WordPronunciation';
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="bg-muted/50 dark:bg-background space-y-3 rounded-lg p-4">
...
export default DictionaryWordDetail;
