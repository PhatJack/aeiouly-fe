...
const Pomodoro: React.FC = () => {
  ...
  return (
    <div className="bg-background flex w-full flex-col space-y-3 rounded-md p-5 shadow-lg">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <TooltipCustom
            content={
              <p>
                Boost <strong>productivity</strong> with a focus session followed by a break. Toggle
                Loop automatically to repeat the cycle, or run a single focus-break session.
              </p>
            }
          >
