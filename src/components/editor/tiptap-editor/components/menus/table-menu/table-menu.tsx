...
export const TableMenu = () => {
  ...
  return (
    <Toolbar>
      ...
      <MenuButton icon="table-cells-split" tooltip="Split cell" onClick={splitCell} />
      <MenuButton icon="table-cells-merge" tooltip="Merge cells" onClick={mergeCells} />
      ...
      />
      <DeleteDropdown deleteColumn={deleteColumn} deleteRow={deleteRow} deleteTable={deleteTable} />
